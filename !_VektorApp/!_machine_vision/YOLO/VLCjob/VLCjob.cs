...
taskkill /F /IM vlc.exe >nul 2>&1 & "C:\Program Files (x86)\VideoLAN\VLC\vlc.exe" "C:\_VIDEO\bootle2.mp4" --start-time=170 --loop --sout "#rtp{mux=ts,sdp=rtsp://:8554/mystream}" --sout-keep
