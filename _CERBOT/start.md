...
sudo docker exec -it docker-nginx-444-certbot-1 certbot certonly --webroot -w /var/www/certbot -d champcup.site  --email umdom2@gmail.com --agree-tos --no-eff-email --force-renewal
