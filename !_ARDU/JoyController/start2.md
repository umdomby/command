...
в SettingsForm после Subtract нужно добавить ограничения ввода левого и правого триггера по минимальному и максимальному значению, должно получится название на английском, четыре ползунка с названиями.  для левого триггера слева мин справа макс, для правого триггера  новой строчки слева мин справа мас. у всех шкала 0 -  255  ползунок мин не должен заходить за ползунок макс.

походу не влезет все в то место, нижние элементы, опусти вниз дай подсказки где изменить высоту.
дай точечный ответ в нужных фйлах, логику не изменяй, просто чтобы последующие настройки триггеров отталкивались от мин и макс сзначений.