React Native Expo go не подходит для WebRTC что ты мне предложил варианты они уёбищные приложение не запускается, какой вариант предложишь ты? вот у меня есть рабочий прототип на react
