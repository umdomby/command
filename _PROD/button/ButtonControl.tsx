...
const ButtonControl = ({onChange, onServoChange, onServoChangeCheck, onRelayChange, disabled}: ButtonControlProps) => {
    const [motorSpeed, setMotorSpeed] = useState(() => {
        ...
        return savedSpeed ? Number(savedSpeed) : 52.25;
    });
        ...
        <div className="flex justify-between items-center h-full w-full relative no-select">
            ...
            <div className="fixed left-4 top-1/2 transform -translate-y-1/2 flex flex-col items-center space-y-2 no-select">
                ...
                <div className="flex space-x-2 no-select">
                    ...
                    <div
                        className="w-10 h-10 rounded-full flex items-center justify-center transition-all no-select"
                    >
                    </div>
                    <button
            ...
            {/* Управление скоростью и ползунки сервоприводов */}
            <div
                className="fixed top-[20%] transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center space-y-2 no-select">
                <div className="flex items-center space-x-2 no-select">
                    ...
                    <span
                        className="text-lg font-medium text-green-300 bg-black/50 px-2 py-0 rounded cursor-pointer no-select"
                ...
                {isSlidersVisible && (
                    <div className="flex flex-col items-center space-y-2 no-select">
                        <div className="w-[60px] top-[40%] no-select">
                        ...
                        <div className="w-[60px] no-select">
