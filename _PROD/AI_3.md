...
# virtualbox https://ardua.site:444/api/virtualbox/logs   curl https://ardua.site:444/api/virtualbox/logs
экран телефона не должен менять ориентацию - цифры снизу, зарядка справа, горизонтальный режим, повторное нажатие, возвращает ориентацию экрана в обычное состояние.

21. Проброс Камеры верх низ
31. Состояние меню серво от базы данных
32. описание проектов-проекта через ИИ
33. сайт
