...
const JoystickTurn = ({ onChange, className, disabled }: JoystickProps) => {
    ...
    const updatePosition = useCallback((clientX: number, clientY: number) => {
        ...
        // Ограничиваем движение ползунка в пределах 60% контейнера (20% отступ сверху и слева, 80% снизу и справа)
