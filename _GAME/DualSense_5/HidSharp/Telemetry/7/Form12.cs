...
namespace TeleUDP
{
    public partial class Form1 : Form
    {
        ...
        private readonly Color transparencyKeyColor = Color.Magenta;
        private readonly Color defaultFormBackColor = Color.Gray; // <-- ИЗНАЧАЛЬНЫЙ ЦВЕТ ФОНА ФОРМЫ
        private int formBackAlpha = 255; // <-- Прозрачность фона формы
        ...
        public Form1()
        {
            ...
            this.BackColor = defaultFormBackColor; // <-- Серый фон
            ...
            UpdateFormBackColor(); // Применяем альфу
        }
        ...
        private void InitializeFormContextMenu()
        {
            ...
            formBackOpacityBar.TrackBar.ValueChanged += (s, ev) =>
            {
                ...
                if (!isOverlayMode)
                    UpdateFormBackColor();
                SaveBlockPositions(); // Сохраняем, если нужно
            };
        ...
        private void ToggleOverlay_Click(object? sender, EventArgs e)
        {
            ...
            if (isOverlayMode)
            {
                ...
                this.BackColor = transparencyKeyColor; // Полная прозрачность
        ...
        private void UpdateFormBackColor()
        {
            if (!isOverlayMode)
            {
                this.BackColor = Color.FromArgb(formBackAlpha, defaultFormBackColor);
            }
        }
        #endregion
        ...
        public class BlockData
        {
            ...
            public int FormBackAlpha { get; set; } = 255; // <-- НОВОЕ
        }
