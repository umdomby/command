...
namespace TeleUDPmini
{
    ...
    {
        public PacketHeader m_header; // 40
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 36)] public byte[] m_dataPadding1; // 36
        public float m_pitch; public float m_roll; public float m_yaw; // 12
        public float m_gForceLateral; public float m_gForceLongitudinal; public float m_gForceVertical; // 12
        ...
        public float m_clutchOrUnused2; public float m_unusedBrake; public float m_gear; // 56
