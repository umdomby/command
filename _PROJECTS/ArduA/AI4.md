...
const char* websocket_server = "ws://192.168.0.151:8085";
...
Я использую Next app ,
мне нужно сделать чтобы устройство ESP8266 и клиент браузер Next https://ardu.site/   общались через сервер
локально данные передаются , https нет, нужно сделать SSL ?
