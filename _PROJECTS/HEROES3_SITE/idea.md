...
b1 > b2 на 10% = - 0.1 кэф   !=  > 100% нельзя
< ставка ниже разницы 25000 1000 < +0.1 нельзя
...
-- коэффициенты, 1.2 регулирование (макс.ставка) boolean - идет ставка или нет - изменения коэфф. умножить - разница.
