...
-- p2p с Telegram Points: +100 Price: -100
-- p2p после часа распределение points
-- telegram p2p
-- margin снять
-- добавить валюту-курсы
-- диалоговое окно о создании сделки
-- в ставках Twitch
-- ставка не кативна если 0.01  и показано сколько макс поставить. Минимально 5.
-- дополнительная защита? - отправить доп пароль на почту (пароль входа) (user-user server password) напомнить отправить пароль
-- глабальное отключение открытых сделок
-- Регистрация турнира
-- Manual
-- Рейтинг p2p

- плавующая статистика - страница
- админка банковские реквизиты изменить удалить - под низ
