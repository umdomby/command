...
export const HEROES_CLIENT: React.FC<Props> = ({ className, user }) => {
    ...
    const [potentialProfit, setPotentialProfit] = useState<number | null>(null); // Состояние для потенциальной прибыли
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            if (isNaN(value) || value <= 0) {
                                                setPlaceBetError('Сумма должна быть положительным целым числом');
                                                setPotentialProfit(null); // Сбрасываем потенциальную прибыль
                                                ...
                                                if (selectedPlayer) {
                                                    ...
                                                    setPotentialProfit(null); // Если игрок не выбран, сбрасываем прибыль
                                                }
                                            }
                                        }}
                                    />
