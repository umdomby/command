            ...
            <Accordion type="single" collapsible className="w-full mt-10">
                <AccordionItem value="item-1">
                    ...
                    <AccordionContent className="bg-red-500 text-white-100 text-lg">
                        ...
                        <div className="mx-3"><p><a className="text-blue-800" target="_blank" href="/">Перейти</a></p>
                        </div>
                    </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-2">
                    ...
                    <AccordionContent className="bg-blue-800 text-white-100 text-lg">
                        <div className="flex mx-3">
                            ...
                            <p>Статистика ставок позволяет пользователям отслеживать свои ставки и анализировать
                                результаты. Это помогает в принятии более обоснованных решений в будущем.</p>
                        </div>
                    </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-3">
                    ...
                    <AccordionContent className="bg-orange-800 text-white-100 text-lg">
                        <div className="mx-3">
                            ...
                            <div className="mx-3"><p><a className="text-blue-800" target="_blank"
                ...
                <AccordionItem value="item-4">
                    ...
                    <AccordionContent className="bg-green-500 text-white-100 text-lg">
                        ...
                        <div className="mx-3"><p><a className="text-blue-800" target="_blank"
                                                    href="/transfer-points">Перейти</a></p></div>
                    </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-5">
                    ...
                    <AccordionContent className="bg-yellow-500 text-white-100 text-lg">
                        ...
                        <div className="mx-3"><p><a className="text-blue-800" target="_blank"
                                                    href="/order-p2p">Перейти</a></p></div>
                    </AccordionContent>
                </AccordionItem>
                    ...
                    <AccordionContent className="bg-orange-500 text-white-100 text-lg">
                        ...
                        <div className="mx-3">
                            <p><a className="text-blue-800" target="_blank" href="/user-game-create-2">Создать
                                игру</a> нужна регистрация!</p>
                            <p><a className="text-blue-800" target="_blank" href="/user-game-2">Найти игру</a> нужна
                                регистрация! </p>
