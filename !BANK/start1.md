...
| Реквизит                  | Обязательно? | Почему                                    |
|---------------------------|--------------|-------------------------------------------|
| **IBAN**                  | Да           | BY25TECN30140000000GR0021881              |
| **SWIFT-код банка**       | Да           | TECNBY22                                  |
| **ФИО получателя**        | Да           | SIARHEI KUNTSEVICH                        |
| **Адрес получателя**      | Обычно да    | 220141 Belarus Minsk str.Shugaeva 17-3-20 |
| **Назначение платежа**    | Да           | polis ARDU Live                           |
| **Валюта и сумма**        | Да           | Указывается отправителем                  |
